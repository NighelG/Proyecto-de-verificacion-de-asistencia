...
async function cargarRespuesta() {
    ...
    for(let index=0; index<cuadroTic.length;index++){
        estudianteInfo[index].textContent="";
        cuadroTic[index].style.pointerEvents="auto";
        cuadroTic[index].dataset.value="";
        cuadroTic[index].classList.remove("ganador")
    }
    turnoUno=true;
