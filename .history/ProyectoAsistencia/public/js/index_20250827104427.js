...
btnRegistro.addEventListener("click", async function () {
    const estudianteInfo={
        ...
        for(let index = 0;index < estudiantes.length; index++){
            ...
            let respuestaB= document.createElement("h2");
            respuestaB.textContent="Registro completado, por favor vuelve e inicia sesion";
            contenedorB.appendChild(respuestaB);
            registroEspacio.appendChild(contenedorB)
    }
        }
